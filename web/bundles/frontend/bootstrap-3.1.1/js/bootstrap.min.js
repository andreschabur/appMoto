...
+function(a){
    ...
    b.DEFAULTS={
        ...
        return this.$element.trigger(j),j.isDefaultPrevented()?void 0:(this.sliding=!0,f&&this.pause(),this.$indicators.length&&(this.$indicators.find(".active").removeClass("active"),this.$element.one("slid.bs.carousel",function(){
            ...
            e.addClass(b),e[0].offsetWidth,d.addClass(g),
            e.addClass(g),
            ...
            setTimeout(function(){
                ...
                /*console.log('lo cambie hp '+e[0]);                
                console.log('lo cambie hp 1 '+e[0].firstChild);                
                console.log('lo cambie hp 11 '+e[0].children[0]);                */
                /*console.log('divs '+e[0].children[0].children[0].children[0]);                
                console.log('<link> '+e[0].children[0].children[0].children[0].children[0]);                
                console.log('<imagen> '+e[0].children[0].children[0].children[0].children[0].children[0]);                */
                //***Ejecutar el jquery en mouseover
                var imagenTemp = e[0].children[0].children[0].children[0].children[0].children[0];
//                imagenTemp.lazyload();
                $( imagenTemp ).trigger( "mouseover" );
//                imagenTemp.lazyload();
                //***
