...
//        $this->em = $em;
    ...
    {
        $form->add($this->factory->createNamed('cilindrajeIdFilter',\Symfony\Bridge\Doctrine\Form\Type\EntityType::class, null, array(
...
//        var_dump($data);
        $mascota = ($data->getCilindrajeIdFilter()) ? $data->getCilindrajeIdFilter()->getManufacturersId() : null ;
...
// var_dump($data);
        $mascota = array_key_exists('manufacturersIdFilter', $data) ? $data['manufacturersIdFilter'] : null;
        $this->addRazaForm($form, $mascota);
    }
