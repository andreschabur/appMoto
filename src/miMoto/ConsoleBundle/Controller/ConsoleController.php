...
namespace miMoto\ConsoleBundle\Controller;
...
use miMoto\ConsoleBundle\Formatter\HtmlOutputFormatterDecorator;
...
class ConsoleController extends Controller
{
    public function consoleAction()
    {
        ...
        return $this->render('ConsoleBundle:Console:console.html.twig', array(
            'working_dir' => getcwd(),
    ...
    public function execAction(Request $request)
    {
        ...
        return $this->render(
            'ConsoleBundle:Console:result.' . $request->getRequestFormat() . '.twig',
            array('commands' => $cmds)
        );
    }
